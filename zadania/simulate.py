...
def waitForPlayerToPressKey():
    # This function waits until the player has pressed any key
    while True:
...
def gameOverAnimation(color=WHITE, animationSpeed=50):
    ...
    instructSurf = instructFont.render('Press any key to play again', True, WHITE)
    instructRect = instructSurf.get_rect()
    instructRect.center = (WINDOWWIDTH // 2, WINDOWHEIGHT // 2 + 60)
    ...
    for i in range(3): # do the flash 3 times
        for start, end, step in ((0, 255, 1), (255, 0, -1)):
            ...
            for alpha in range(start, end, animationSpeed * step): # animation loop
                ...
                # Display Game Over text after flashing
                if i == 2 and start == 255:
    ...
    # Keep showing Game Over message until a key is pressed
    DISPLAYSURF.blit(origSurf, (0, 0))
    DISPLAYSURF.blit(flashSurf, (0, 0))
    drawButtons()
    DISPLAYSURF.blit(gameOverSurf, gameOverRect)
